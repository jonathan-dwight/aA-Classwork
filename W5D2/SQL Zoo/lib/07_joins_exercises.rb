...
def films_by_cast_size
  ...
  # only need to joining the casitings to the movie id
  execute(<<-SQL)
  SELECT 
...
def colleagues_of_garfunkel
  ...
  # want to create the first sub-query join in the from jsut to include movies with Art
  # want join now the table of actors with the casting_actor_id  
  ...
  JOIN (
    ...
    WHERE
      actors.name != 'Art Garfunkel'
    ) AS co_actors ON art_movies.id = co_actors.movie_id; 
